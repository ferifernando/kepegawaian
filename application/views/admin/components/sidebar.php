<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" data-color="dark" id="sidenav-main">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
        <a class="navbar-brand m-0" href="<?= site_url(); ?>" target="_blank">
            <img src="<?= base_url('assets/images/favicon.png') ?>" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link <?= $this->uri->segment(1) == 'admin' || $this->uri->segment(1) == 'level' ? 'active expand' : 'collapse'; ?>" data-bs-toggle="collapse" data-bs-target="#adminToggle" aria-controls="adminToggle" role="button" aria-expanded="false">
                ...
                <div class="collapse <?= $this->uri->segment(1) == 'admin' || $this->uri->segment(1) == 'level' ? 'show' : ''; ?>" id="adminToggle">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item <?= $this->uri->segment(1) == 'admin' ? 'active' : ''; ?>">
                            <a class="nav-link <?= $this->uri->segment(1) == 'admin' ? 'active' : ''; ?>" href="<?= site_url('admin'); ?>">
                                <span class="sidenav-normal">Daftar Admin</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link <?= $this->uri->segment(1) == 'level' ? 'active' : ''; ?>" href="<?= site_url('level'); ?>">
                                <span class="sidenav-normal">Level Admin</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link <?= $this->uri->segment(1) == 'pegawai' || $this->uri->segment(1) == 'jabatan' ? 'active expand' : 'collapse'; ?>" data-bs-toggle="collapse" data-bs-target="#pegawaiToggle" aria-controls="pegawaiToggle" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse <?= $this->uri->segment(1) == 'pegawai' || $this->uri->segment(1) == 'jabatan' ? 'show' : ''; ?>" id="pegawaiToggle" style="">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link <?= $this->uri->segment(1) == 'pegawai' ? 'active' : ''; ?>" href="<?= site_url('pegawai'); ?>">
                                <span class="sidenav-normal">Daftar Pegawai</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link <?= $this->uri->segment(1) == 'jabatan' ? 'active' : ''; ?>" href="<?= site_url('jabatan'); ?>">
                                <span class="sidenav-normal">Daftar Jabatan</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('login/out'); ?>" onclick="return confirm('Apakah anda yakin ingin keluar ?')">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
